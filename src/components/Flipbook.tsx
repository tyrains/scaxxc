...
import { ChevronLeft, ChevronRight, Leaf, ShieldCheck, Activity, BarChart3 } from 'lucide-react';
...
export default function Flipbook() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-100 p-4 md:p-8 font-sans">
        ...
        >
          ...
          <Page isCover>
            <div className="h-full flex flex-col justify-center items-center text-center space-y-8">
              <div className="w-48 h-24 flex items-center justify-center mb-8">
                <img src="https://i.postimg.cc/MZ7hW88f/logo2.png" alt="数诚安信" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
              </div>
          ...
          <Page>
            <div className="h-full flex flex-col justify-center items-center text-center opacity-20">
              <img src="https://i.postimg.cc/MZ7hW88f/logo2.png" alt="数诚安信" className="w-48 object-contain grayscale" referrerPolicy="no-referrer" />
            </div>
          </Page>
          ...
          <Page number={3}>
            ...
            <div className="mb-6">
              <div className="h-56 bg-slate-50 rounded-xl flex items-center justify-center border border-slate-200 shadow-inner overflow-hidden relative p-2">
                <img src="https://i.postimg.cc/xCXXyCfx/zmt.png" alt="能碳一体机设备" className="object-contain w-full h-full opacity-95 mix-blend-multiply" referrerPolicy="no-referrer" />
          ...
          <Page isCover>
            <div className="h-full flex flex-col justify-between items-center text-center py-12">
              <div className="w-full flex-grow flex flex-col items-center justify-center">
                <img src="https://i.postimg.cc/MZ7hW88f/logo2.png" alt="数诚安信" className="w-32 object-contain mb-6 opacity-80" referrerPolicy="no-referrer" />
                ...
                <div className="w-32 h-32 bg-white rounded-lg p-2 mb-8 shadow-2xl">
                  {/* QR Code Placeholder */}
                  <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://example.com" alt="QR Code" className="w-full h-full" referrerPolicy="no-referrer" />
                </div>
